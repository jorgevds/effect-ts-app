...
export const ChoreCompleteButton = ({ id }: { id: string }) => {
    ...
    return (
        <>
            <form action={action}>
                <button className="py-3 px-4 inline-flex items-center text-sm font-medium rounded-lg border border-transparent bg-yellow-100 text-yellow-800 hover:bg-yellow-200 focus:outline-none focus:bg-blue-200 disabled:opacity-50 disabled:pointer-events-none">
                    Complete chore
                </button>
            </form>
            <FormToast
